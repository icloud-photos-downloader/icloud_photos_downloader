...
``` sh
scripts/build_bin_linux 1.20.3 amd64
```
...
``` sh
scripts/build_binary_dist_linux 1.20.3
```
...
- Add version tag to head (`git tag v1.20.3`) and push it to master (`git push origin v1.20.3`) -- there seems to be no way to do that in UI
