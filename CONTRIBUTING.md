...
``` sh
scripts/build_bin_linux 1.20.1 amd64
```
...
``` sh
scripts/build_binary_dist_linux 1.20.1
```
...
- Add version tag to head (`git tag v1.20.1`) and push it to master (`git push origin v1.20.1`) -- there seems to be no way to do that in UI
