...
class PathsTestCase(TestCase):
    def test_disambiguate_filenames_all_diff(self) -> None:
        ...
        _setup: Dict[VersionSize, AssetVersion] = {
            AssetVersionSize.ORIGINAL:
                AssetVersion( "IMG_1.DNG", 1, "http", "jpeg")
            ,
            AssetVersionSize.ALTERNATIVE:
                AssetVersion( "IMG_1.HEIC", 1, "http", "jpeg")
            ,
            AssetVersionSize.ADJUSTED:
                AssetVersion( "IMG_1.JPG", 1, "http", "jpeg")
            ,
            ...
            LivePhotoVersionSize.ORIGINAL:
                AssetVersion( "IMG_1.MOV", 1, "http", "jpeg")
            ,
    ...
    def test_disambiguate_filenames_keep_orgraw_alt_adj(self) -> None:
        ...
        _expect: Dict[VersionSize, AssetVersion] = {
            ...
            ,
            AssetVersionSize.ALTERNATIVE:
                AssetVersion( "IMG_1-alternative.JPG", 1, "http", "jpeg")
            ,
            AssetVersionSize.ADJUSTED:
                AssetVersion( "IMG_1.JPG", 1, "http", "jpeg")
            ,
    ...
    def test_disambiguate_filenames_keep_all_when_org_adj_same(self) -> None:
        ...
        _setup: Dict[VersionSize, AssetVersion] = {
            ...
            ,
            AssetVersionSize.ALTERNATIVE:
                AssetVersion( "IMG_1.CR2", 1, "http", "jpeg")
            ,
            AssetVersionSize.ADJUSTED:
                AssetVersion( "IMG_1.JPG", 1, "http", "jpeg")
            ,
        ...
        _expect: Dict[VersionSize, AssetVersion] = {
            ...
            ,
            AssetVersionSize.ADJUSTED:
                AssetVersion( "IMG_1-adjusted.JPG", 1, "http", "jpeg")
            ,
        }
